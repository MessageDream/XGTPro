...
- (id)initWithSectionTitles:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.type = CustomSegmentedControlTypeText;
    }
...
- (id)initWithSectionImages:(NSArray*)sectionImages sectionSelectedImages:(NSArray*)sectionSelectedImages {
    ...
    if (self) {
        ...
        self.type = CustomSegmentedControlTypeImages;
    }
...
- (instancetype)initWithSectionImages:(NSArray *)sectionImages sectionSelectedImages:(NSArray *)sectionSelectedImages titlesForSections:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.sectionSelectedImages = sectionSelectedImages;
		self.sectionTitles = sectiontitles;
        self.type = CustomSegmentedControlTypeTextImages;
    }
...
- (void)commonInit {
    ...
    self.selectionStyle = CustomSegmentedControlSelectionStyleTextWidthStripe;
    self.selectionIndicatorLocation = CustomSegmentedControlSelectionIndicatorLocationUp;
    self.segmentWidthStyle = CustomSegmentedControlSegmentWidthStyleFixed;
...
- (void)setSelectionIndicatorLocation:(CustomSegmentedControlSelectionIndicatorLocation)selectionIndicatorLocation {
	_selectionIndicatorLocation = selectionIndicatorLocation;
	
	if (selectionIndicatorLocation == CustomSegmentedControlSelectionIndicatorLocationNone) {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == CustomSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight)/2 - stringHeight/2 + ((self.selectionIndicatorLocation == CustomSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
            
            CGRect rect;
            if (self.segmentWidthStyle == CustomSegmentedControlSegmentWidthStyleFixed) {
                rect = CGRectMake((self.segmentWidth * idx) + (self.segmentWidth - stringWidth)/2, y, stringWidth, stringHeight);
            } else if (self.segmentWidthStyle == CustomSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == CustomSegmentedControlTypeImages) {
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            UIImage *icon = iconImage;
            CGFloat imageWidth = icon.size.width;
            CGFloat imageHeight = icon.size.height;
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2 - imageHeight / 2 + ((self.selectionIndicatorLocation == CustomSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
    ...
    } else if (self.type == CustomSegmentedControlTypeTextImages){
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
    ...
    if (self.selectedSegmentIndex != CustomSegmentedControlNoSegment) {
        if (self.selectionStyle == CustomSegmentedControlSelectionStyleArrow) {
            ...
            if (!self.selectionIndicatorStripLayer.superlayer) {
                ...
                if (self.selectionStyle == CustomSegmentedControlSelectionStyleBox && !self.selectionIndicatorBoxLayer.superlayer) {
...
- (void)setArrowFrame {
    ...
    if (self.selectionIndicatorLocation == CustomSegmentedControlSelectionIndicatorLocationDown) {
    ...
    if (self.selectionIndicatorLocation == CustomSegmentedControlSelectionIndicatorLocationUp) {
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == CustomSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == CustomSegmentedControlSelectionStyleTextWidthStripe &&
            sectionWidth <= self.segmentWidth &&
            self.segmentWidthStyle != CustomSegmentedControlSegmentWidthStyleDynamic) {
            CGFloat widthToEndOfSelectedSegment = (self.segmentWidth * self.selectedSegmentIndex) + self.segmentWidth;
            CGFloat widthToStartOfSelectedIndex = (self.segmentWidth * self.selectedSegmentIndex);
            ...
            if (self.segmentWidthStyle == CustomSegmentedControlSegmentWidthStyleDynamic) {
...
- (void)updateSegmentsRects {
    ...
    if (self.type == CustomSegmentedControlTypeText && self.segmentWidthStyle == CustomSegmentedControlSegmentWidthStyleFixed) {
    ...
    } else if (self.type == CustomSegmentedControlTypeText && self.segmentWidthStyle == CustomSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == CustomSegmentedControlTypeTextImages && CustomSegmentedControlSegmentWidthStyleFixed){
    ...
    } else if (self.type == CustomSegmentedControlTypeTextImages && CustomSegmentedControlSegmentWidthStyleDynamic) {
        NSMutableArray *mutableSegmentWidths = [NSMutableArray array];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint(self.bounds, touchLocation)) {
        ...
        } else if (self.type == CustomSegmentedControlTypeTextImages || self.type == CustomSegmentedControlTypeText) {
...
- (void)setSelectedSegmentIndex:(NSUInteger)index animated:(BOOL)animated notify:(BOOL)notify {
    ...
    if (index == CustomSegmentedControlNoSegment) {
        ...
        if (animated) {
            ...
            if(self.selectionStyle == CustomSegmentedControlSelectionStyleArrow) {
                ...
                if ([self.selectionIndicatorStripLayer superlayer] == nil) {
                    ...
                    if (self.selectionStyle == CustomSegmentedControlSelectionStyleBox && [self.selectionIndicatorBoxLayer superlayer] == nil)
                        [self.scrollView.layer insertSublayer:self.selectionIndicatorBoxLayer atIndex:0];
